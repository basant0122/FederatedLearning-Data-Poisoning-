...
class Client:
    ...
    def calculate_class_recall_src1(self, confusion_mat,mal):
        ...
        """
        return 100 * (confusion_mat[mal['back']][mal['back']]) / numpy.sum(confusion_mat[mal['back']], axis=0)

    def calculate_class_recall_target1(self, confusion_mat,mal):
        """
        Calculates the recall for target class from a confusion matrix.
        """
        return 100 * (confusion_mat[mal['target']][mal['target']]) / numpy.sum(confusion_mat[mal['target']], axis=0)
