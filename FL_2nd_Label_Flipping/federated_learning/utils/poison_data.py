...
def poison_data(logger, distributed_dataset, num_workers, poisoned_worker_ids, replacement_method,mal,mal1,args):
    """
    Poison worker data
    ...
    for worker_idx in range(num_workers):
        if worker_idx in poisoned_worker_ids:
             ...
             poisoned_dataset.append(apply_class_label_replacement(distributed_dataset[worker_idx][0], distributed_dataset[worker_idx][1], replacement_method,mal,mal1,worker_idx,args))
             #poisoned_dataset.append(apply_class_label_replacement(distributed_dataset[worker_idx][0], distributed_dataset[worker_idx][1], replacement_method,mal,worker_idx,args))
