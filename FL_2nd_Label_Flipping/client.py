...
class Client:
    ...
    def calculate_class_recall_src(self, confusion_mat,mal):
        """
    ...
    def calculate_class_recall(self, confusion_mat,mal):
        ...
        """
        return 100 * numpy.diagonal(confusion_mat) / numpy.sum(confusion_mat, axis=1)

    def calculate_class_recall_target(self, confusion_mat,mal):
        """
    ...
    #     return list( numpy.around(2 * (numpy.array(c_p) * numpy.array(c_r))/(numpy.array(c_p) + numpy.array(c_r)),2))
    ...
    def test(self , mal):
        ...
        recall = numpy.around(sum(class_recall)/len(class_recall),3)
        class_recall_target = self.calculate_class_recall_target(confusion_mat , mal)
        class_recall_src = self.calculate_class_recall_src(confusion_mat , mal)
        ...
        return accuracy ,class_recall_src, class_recall_target, recall
